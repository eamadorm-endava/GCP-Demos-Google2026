...
// Aligned with the new, more detailed workflow.
...
// FIX: Add Farm types to be used in src/App.tsx
...
export interface Shipment {
  ...
  hawb: string;
  customer: string;
  // FIX: Add missing farmId to resolve type mismatch with data from constants.ts
  farmId: string;
