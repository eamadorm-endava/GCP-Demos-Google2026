...
export const FlowerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.255 12c0 1.22-.056 2.414-.164 3.582-.123 1.343-.37 2.656-.73 3.92C19.96 20.618 19.12 21 18.25 21H5.75c-.87 0-1.71-.382-2.111-1.498-.36-1.264-.607-2.577-.73-3.92C2.806 14.414 2.75 13.22 2.75 12c0-5.113 4.137-9.25 9.25-9.25s9.25 4.137 9.25 9.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12c0-1.077-.24-2.103-.68-3.033-.437-.923-1.07-1.755-1.87-2.443C13.15 5.833 12.11 5.5 11 5.5c-2.485 0-4.5 2.015-4.5 4.5S8.515 14.5 11 14.5c.677 0 1.325-.147 1.92-.416" />
    </svg>
);
...
export const ChatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.05 1.05 0 00-1.485 0L12 14.53l-2.565-2.565a1.05 1.05 0 00-1.485 0L5.22 14.22a2.1 2.1 0 01-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097M15.75 6.75v-1.5a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v1.5" />
    </svg>
);
...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c.065.21.145.425.24.641a11.98 11.98 0 004.26 3.309.525.525 0 00.48 0c1.53-.782 2.898-2.076 3.932-3.72.106-.176.21-.36.313-.553a7.5 7.5 0 01-2.488.005z" /></svg>
);

export const SpinnerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.69a8.25 8.25 0 01-11.667 0l-3.181 3.183" /></svg>
);
...
export const ClipboardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a2.25 2.25 0 01-2.25 2.25h-1.5a2.25 2.25 0 01-2.25-2.25V4.5A2.25 2.25 0 019 2.25h3A2.25 2.25 0 0113.5 4.5v0c0 .212.03.418.084.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V7.252c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184" />
  </svg>
);
...
export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.5-12.75a.75.75 0 01.75.75v14.25a.75.75 0 01-1.5 0V4.5a.75.75 0 01.75-.75zM4.5 10.5a.75.75 0 00.75.75h13.5a.75.75 0 000-1.5H5.25a.75.75 0 00-.75.75z" />
  </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023.57-2.206 0-3.228m-5.78 3.228c.57 1.023.57 2.206 0 3.228m3.11-11.453a9.049 9.049 0 011.583 5.43m-3.11-5.43a9.049 9.049 0 00-1.583 5.43m12.352 2.962c.576 1.023.576 2.206 0 3.228m-3.11-11.453a9.043 9.043 0 01-1.583 5.43m-1.583-5.43a9.043 9.043 0 00-1.583 5.43m1.583 0c.57 1.023.57 2.206 0 3.228m6.22-11.453a9.043 9.043 0 01-1.583 5.43m-1.583-5.43a9.043 9.043 0 00-1.583 5.43m6.22 0c.576 1.023.576 2.206 0 3.228m3.11 0c.57 1.023.57 2.206 0 3.228m-1.583-14.68a9.049 9.049 0 011.583 5.43m-12.352 0a9.049 9.049 0 011.583 5.43m-1.583 5.43a9.049 9.049 0 001.583-5.43m-1.583-5.43a9.049 9.049 0 01-1.583-5.43m0 5.43a9.049 9.049 0 00-1.583 5.43m0-5.43a9.049 9.049 0 011.583-5.43" /></svg>
);
...
export const BuildingOfficeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5v-4.5m-3.75 3.75v-3.75m-3.75 3.75v-3.75M3 15h12M9.75 3v10.5a3 3 0 003 3h3.75a3 3 0 003-3V3h-9.75z" /></svg>
);
...
export const ClipboardDocumentCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 5.25c0 .165.043.32.12.45l.966 1.61c.145.242.41.39.696.39h.002c.287 0 .553-.15.698-.393l2.808-4.68A.75.75 0 0021.144 2l-2.678 4.463-1.096-1.826a.75.75 0 00-1.286.772l1.608 2.68c.145.242.41.39.696.39h.002c.287 0 .553-.15.698-.393l4.312-7.186" transform="translate(-1 3) scale(0.6)" /></svg>
);