    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className={`flex-1 overflow-y-auto max-w-7xl mx-auto px-4 md:px-8 py-8 animate-fade-in w-full`}>
        <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-4 bg-[#30404B]/50 p-2 rounded-2xl border border-[#47555F] glass-panel self-start md:self-auto">
            ...
            <div className={`w-12 h-12 bg-gradient-to-br from-[#47555F] to-[#192B37] rounded-xl flex items-center justify-center text-white border border-[#47555F] shadow-lg`}>
        ...
        <footer className="mt-16 pt-8 border-t border-[#47555F]">
          <h3 className="text-center text-xs font-bold text-[#758087] uppercase tracking-widest mb-6">System Status</h3>
          <div className="flex flex-col md:flex-row justify-around items-center text-center md:text-left gap-8">
            <div className="text-sm">
              <span className="text-[#A3AAAF] block">Data Pipeline</span>
            ...
            <div className="text-sm">
              <span className="text-[#A3AAAF] block">Model Training</span>
              <span className="text-[#E8EAEB] font-medium">Scheduled (02:00 AM)</span>
            </div>
            <div className="text-sm">
              <span className="text-[#A3AAAF] block">API Latency</span>
              <span className="text-[#E8EAEB] font-medium">45ms</span>
            </div>
          </div>
        </footer>
      </div>
