...
const AdminView: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-[#192B37]/90 backdrop-blur-2xl flex items-center justify-center p-4 md:p-10 animate-in fade-in zoom-in-95 duration-300">
      <div className="w-full max-w-4xl bg-[#121417] rounded-[2.5rem] border border-[#47555F] overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] flex flex-col h-full max-h-[85vh]">

        {/* Header */}
        <div className="p-8 md:p-10 border-b border-[#30404B] flex items-center justify-between flex-shrink-0 bg-white/5">
          <div className="flex items-center gap-6">
            <div className="p-4 rounded-2xl bg-white/10 border border-[#47555F]">
              <Terminal className="w-8 h-8 text-[#FF5640]" />
            </div>
            <div>
              <h2 className="text-3xl font-black uppercase tracking-tight">Showcase <span className="text-[#FF5640]">Control Center</span></h2>
        ...
        {/* Tabs */}
        <div className="flex border-b border-[#30404B] flex-shrink-0">
          <button
            onClick={() => setActiveTab('ai')}
            className={`flex-1 py-6 font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-all ${activeTab === 'ai' ? 'text-[#FF5640] bg-white/5 border-b-2 border-[#FF5640]' : 'text-gray-500 hover:text-white'}`}
          >
            <Sparkles className="w-5 h-5" /> AI Generator
          </button>
          <button
            onClick={() => setActiveTab('external')}
            className={`flex-1 py-6 font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-all ${activeTab === 'external' ? 'text-[#FF5640] bg-white/5 border-b-2 border-[#FF5640]' : 'text-gray-500 hover:text-white'}`}
          >
        ...
        <div className="flex-grow overflow-y-auto p-8 md:p-12 custom-scrollbar">
          {activeTab === 'ai' ? (
            <div className="space-y-8 animate-in slide-in-from-left-4 duration-300">
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-48 bg-black/40 border border-[#47555F] rounded-3xl p-6 text-xl font-light focus:border-[#FF5640]/50 focus:ring-1 focus:ring-[#FF5640]/20 transition-all outline-none resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-6 rounded-2xl bg-[#FF5640] hover:bg-[#d44733] text-white font-black text-xl flex items-center justify-center gap-4 transition-all active:scale-95 disabled:opacity-50 shadow-lg shadow-[#FF5640]/20"
              >
                {isGenerating ? (
                  <>
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-[#47555F] rounded-xl p-4 font-bold outline-none focus:border-[#FF5640]"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-4 pt-4 border-t border-[#30404B]">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-[#47555F] rounded-xl p-4 outline-none mb-3"
                />
                <input
                ...
                <div className="space-y-2">
                  {externalForm.talkingPoints.map((tp, i) => (
                    <input
                      ...
                      className="w-full bg-white/5 border border-[#47555F] rounded-xl p-3 text-sm outline-none"
                    />
                  ))}
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-5 rounded-2xl bg-white text-black font-black text-lg flex items-center justify-center gap-4 transition-all active:scale-95 hover:bg-[#FF5640] hover:text-white"
              >
