  ...
  return (
    <Card className="border border-brand-accent/20">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold text-brand-text">Supplier Agreement Registry</h3>
        ...
        <table className="min-w-full divide-y divide-brand-accent/30">
          <thead>
            <tr>
              ...
              <th scope="col" className="px-6 py-4 text-left text-[10px] font-bold text-brand-light uppercase tracking-widest">Supplier / Vendor</th>
