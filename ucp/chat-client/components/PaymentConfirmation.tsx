...
const PaymentConfirmationComponent: React.FC<PaymentConfirmationProps> = ({
  ...
  return (
    <div className="max-w-md bg-white rounded-xl shadow-card p-4 border border-solidBlue-20">
      ...
      <div className="flex justify-between items-center text-md mb-4 text-brand-dark">
      ...
      <p className="text-solidBlue-70 mb-4">
      ...
      <button
        ...
        className="flex justify-center items-center w-full text-center bg-signal-light-positive text-white py-2 rounded-md hover:brightness-95 transition-colors disabled:bg-signal-light-positive/70 disabled:cursor-wait">
        {isConfirming ? (
          <>
            <svg
              title="Processing"
