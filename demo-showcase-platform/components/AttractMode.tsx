...
const AttractMode: React.FC = () => {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] bg-endava-dark flex flex-col items-center justify-center cursor-pointer animate-in fade-in duration-1000"
      onClick={updateActivity}
    >
      <div className="relative w-full h-full overflow-hidden flex items-center justify-center">
        {/* Endava Themed Background */}
        <div className="absolute inset-0 bg-gradient-to-tr from-endava-orange/20 via-black to-black animate-pulse" />

        {/* Kinetic Tech Patterns */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(#FF5640_1px,transparent_1px)] [background-size:40px_40px]" />
        </div>
        ...
        <div className="z-10 text-center space-y-8 md:space-y-12 px-6 max-w-5xl">
          <div className="flex justify-center mb-6">
            <div className="relative animate-in zoom-in duration-700">
              <div className="absolute inset-0 bg-endava-orange blur-3xl opacity-20 animate-pulse rounded-2xl" />
          ...
          <p className="text-lg md:text-2xl lg:text-3xl text-gray-300 font-medium max-w-3xl mx-auto leading-relaxed px-4">
            Accelerating Digital Evolution with <span className="text-endava-orange font-black">Google Cloud</span>
          </p>

          <div className="mt-8 md:mt-16 animate-bounce">
            <div className="bg-endava-orange text-white px-8 md:px-12 py-4 md:py-6 rounded-full shadow-[0_0_50px_rgba(255,86,64,0.3)] font-black text-xl md:text-3xl tracking-wide uppercase">
              Start Exploring
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-12 left-0 right-0 text-center flex flex-col items-center gap-3">
        <div className="w-16 h-1 bg-endava-orange rounded-full" />
