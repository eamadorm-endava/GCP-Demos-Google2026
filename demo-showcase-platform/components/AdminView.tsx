...
const AdminView: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-black/90 backdrop-blur-2xl flex items-center justify-center p-4 md:p-10 animate-in fade-in zoom-in-95 duration-300">
      <div className="w-full max-w-4xl bg-endava-dark rounded-[2.5rem] border border-white/10 overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] flex flex-col h-full max-h-[85vh]">
        ...
        <div className="p-8 md:p-10 border-b border-white/5 flex items-center justify-between flex-shrink-0 bg-white/5">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="text-3xl font-black uppercase tracking-tight">Showcase <span className="text-endava-orange">Control Center</span></h2>
        ...
        <div className="flex border-b border-white/5 flex-shrink-0">
          <button
            ...
            className={`flex-1 py-6 font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-all ${activeTab === 'ai' ? 'text-endava-orange bg-white/5 border-b-2 border-endava-orange' : 'text-gray-500 hover:text-white'}`}
          >
            <Sparkles className="w-5 h-5" /> AI Generator
          </button>
          <button
            onClick={() => setActiveTab('external')}
            className={`flex-1 py-6 font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-all ${activeTab === 'external' ? 'text-endava-orange bg-white/5 border-b-2 border-endava-orange' : 'text-gray-500 hover:text-white'}`}
          >
          ...
          {activeTab === 'ai' ? (
            <div className="space-y-8 animate-in slide-in-from-left-4 duration-300">
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-48 bg-black/40 border border-white/10 rounded-3xl p-6 text-xl font-light focus:border-endava-orange/50 focus:ring-1 focus:ring-endava-orange/20 transition-all outline-none resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-6 rounded-2xl bg-endava-orange hover:opacity-90 text-white font-black text-xl flex items-center justify-center gap-4 transition-all active:scale-95 disabled:opacity-50 shadow-lg shadow-endava-orange/20"
              >
                {isGenerating ? (
                  <>
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl p-4 font-bold outline-none focus:border-endava-orange"
                  />
                </div>
                <div className="space-y-2">
              ...
              <button
                ...
                className="w-full py-5 rounded-2xl bg-white text-black font-black text-lg flex items-center justify-center gap-4 transition-all active:scale-95 hover:bg-endava-orange hover:text-white"
              >
